...
[![embedded](./assets/images/API.png)](https://posit-dev.github.io/gt-extras/reference/)
...
filtered_data = (
    sp500
    .assign(date=pd.to_datetime(sp500['date']))  # Convert to datetime first
    .query("date >= '2015-01-05' and date <= '2015-01-16'")
    .sort_values('date')
    .assign(week=lambda x: 'W' + x['date'].dt.strftime('%V'))
    .drop(columns=['adj_close', 'volume'])
)

gt = (
    GT(filtered_data, rowname_col="date", groupname_col="week")
    .fmt_number(
...
(
    GT(exibble.iloc[:, -5:], groupname_col="group")
    .tab_options(
        table_background_color="transparent",
...
::: {.fragment fragment-index=3 fragment-index=4 .fade-in}
...
<!-- add community building (github prs) -->
<!-- add slide on docs? -->
<!-- more code examples -->
<!-- include some struggles -->
<!-- include the posit blog post -->
