...
:::{.fragment}
![](./assets/images/excel_table.png){.absolute width=260px height=115px left=856px top=145px}
:::
...
::: {.fragment}
![](./assets/images/angry_bills.png){ .absolute width=150px height=200px left=10px top=500px}
:::
...
::: {.fragment}
![](./assets/images/upset_browns.png){ .absolute width=160px height=240 left=180px top=350px}
:::
...
::: {.fragment}
![](./assets/images/happy_dolphins.png){ .absolute width=180px height=250 left=158px top=400px}
:::
...
::: {.fragment}
![](./assets/images/upset_49ers.jpg){ .absolute width=180px height=200 left=251px top=460px}
...
::: {.fragment fragment-index=8 .fade-in-then-out}
#### `gte.gt_plt_winloss()`
...
::: {.fragment fragment-index=9 .fade-in-then-out}
#### `gte.gt_plt_dumbbell()`
...
::: {.fragment fragment-index=10 .fade-in-then-out}
#### `gte.gt_fa_rank_change()`
...
::: {.fragment fragment-index=12 .fade-in-then-out}
#### `gte.gt_theme_538()`
...
::: {.fragment fragment-index=13 .fade-in-then-out}
#### `gte.gt_two_column_layout()`
