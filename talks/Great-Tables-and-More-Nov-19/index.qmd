...
#| eval: false
#| code-line-numbers: "1"
gt = gt.pipe(gte.gt_add_divider, columns="Point Diff", color="darkblue", weight=2)
```
...
gt_final = gte.gt_two_column_layout(gt1, gt2, table_header_from=1)
```
