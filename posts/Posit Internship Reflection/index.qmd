...
4.  make html and post-processing steps simple
...
![A mega-example built with the gt-extas library](../../images/2011-nfl-season.png.png){width=36em fig-align="center"}
...
<!-- Change links to PRs not issues -->
* a row striping indexing [bug](https://github.com/posit-dev/great-tables/issues/700) with grouped data 
* a data coloring palette [bug](https://github.com/posit-dev/great-tables/issues/717)
* an [improvement](https://github.com/posit-dev/great-tables/issues/744) to autocoloring the text of striped rows 
* an [improvement](https://github.com/posit-dev/great-tables/issues/746) to autocoloring in semi-transparent elements 
...
In every instance (yes, even the [slides](../../talks/Posit%20Open%20Souce%20Reflection/index.qmd)), my musings are presented with the help of Quarto markdown. I promise I'm not getting paid to say this, but having never used Quarto before this summer, I can confidently say I can't imagine a life without it. Life with Quarto was especially easy when the team that maintains it was part of the organization I worked for :) which I'll definitely miss. Instead, I guess you'll find me lurking in GitHub issues.
