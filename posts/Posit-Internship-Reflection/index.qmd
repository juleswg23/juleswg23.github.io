...
subtitle: "My experience as a 2025 Posit intern"
date: 2025-08-04
date-modified: 2025-08-21
author: Jules Walzer-Goldfeld
toc: true
toc-expand: true
image: ../../images/2011-nfl-season.png
---

I spent the summer working for Posit (formerly known as RStudio), and I loved it. I was on the tinytools squad, as an intern for [**Great Tables**](https://posit-dev.github.io/great-tables/), the Python port of {gt} in R. My team was responsible for many of the major ports from Posit's R packages to Python. They are awesome – this is certainly an incomplete list, but they've created the Python versions of {ggplot2}, {pointblank}, {scales}, {forcats}, {dplyr}, and {reactable}, to name a few.

My summer consisted of:

- Building and packaging a Python library ([**gt-extras**](https://posit-dev.github.io/gt-extras/))
- Contributing fixes and features upstream to **Great Tables**
- Presenting and promoting the open source work
- Pairing with mentors and collaborating across Posit
